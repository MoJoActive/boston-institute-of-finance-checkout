...
class AddressForm extends Component<AddressFormProps & WithLanguageProps & any> {
          ...
          <div className="checkout-address" ref={this.containerRef as RefObject<HTMLDivElement>}>
            {formFields
              ...
              .map((field: any) => {
                if (field.name === 'email') {
                  return (
                    <div className="dynamic-form-field dynamic-form-field--email" key={field.name}>
                      <div className="form-field">
                        ...
                        <Input
                          ...
                          name="email"
                          onBlur={() => {
                            this.props.continueAsGuest?.({ email: this.state.email });
                          }}
  ...
  private syncNonFormikValue: (fieldName: string, value: string | string[]) => void = (
    ...
    const dateFormFieldNames = formFields
      .filter((field: any) => field.custom && field.fieldType === DynamicFormFieldType.date)
...
export function mapToCheckoutProps(context: CheckoutContextProps) {
  const {
    checkoutState: {
...
export default withLanguage(withCheckout(mapToCheckoutProps)(AddressForm));
