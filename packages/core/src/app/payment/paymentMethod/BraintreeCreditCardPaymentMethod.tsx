  ...
  const initializeBraintreePayment: BraintreeCreditCardPaymentMethodProps['initializePayment'] =
    useCallback(
      async (options, selectedInstrument) => {
        console.log('initializeBraintreePayment', {
          options,
          selectedInstrument,
          formOptions: getHostedFormOptions && (await getHostedFormOptions(selectedInstrument)),
        });
        ...
        return initializePayment({
          ...
          braintree: {
            ...
            form: getHostedFormOptions && (await getHostedFormOptions(selectedInstrument)) as any,
          },
        });
      },
